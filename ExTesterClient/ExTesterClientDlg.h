...
class CExTesterClientDlg : public CDialogEx
{
// 생성입니다.
public:
	CExTesterClientDlg(CWnd* pParent = nullptr);	// 표준 생성자입니다.
	~CExTesterClientDlg();
// 대화 상자 데이터입니다.
#ifdef AFX_DESIGN_TIME
	enum { IDD = IDD_EXTESTERCLIENT_DIALOG };
#endif
...
public:
	...
	void ShowRecvData(CExTesterClientDlg* dlg, char* packet, int packetSize);
	...
	afx_msg void OnBnClickedBtnCreateItgrPacket();
	afx_msg void OnBnClickedBtnCreatePostPacket();
	afx_msg void OnBnClickedBtnCreateCmpPacket();
	afx_msg void OnBnClickedBtnCreateHiplusPacket();
};